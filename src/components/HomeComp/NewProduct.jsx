import { NewProductDetails } from "./../../data";
const NewProduct = () => {
  return (
    <>
      <section className="mainPadding bg-black py-20">
        <h2 className="text-center text-white text-3xl font-semibold">NEW PRODUCTS</h2>

        <div className="grid lg:grid-cols-4 grid-cols-2 gap-10 mt-10">
          {NewProductDetails.map((list) => {
            return (
              <div
                key={list.id}
              ...
              >
                ...
                <div className="flex justify-between text-white flex-wrap">
                  ...
                  <button className="bg-[#B98907] hover:bg-[#6a551b] text-white py-1 px-4 rounded-md">
                    {list.click}
                  </button>
                </div>
              </div>
