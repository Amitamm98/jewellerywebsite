    ...
    <>
      <section className="contact">
        <div className="mainPadding text-white">
          ...
          <p className="my-7 text-lg">
          We’re here to assist you with every sparkle. Whether it’s a query, custom request, or guidance, connect with us — your perfect jewellery experience begins with a conversation.
          </p>
          <div className="text-center">
            <button className="bg-[#B38B20] hover:bg-[#7e6523] text-white text-xl py-3 px-12 rounded shadow-md">
              JOIN NOW!
            </button>
          </div>
        </div>
